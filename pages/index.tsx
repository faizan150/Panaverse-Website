    ...
    <>
      <div className="container-fluid">
        <div className="row fixed-top">
          <nav className="navbar navbar-expand-lg  navbar-light bg-light p-2 p-md-4">
            <div className="container-fluid">
              ...
              >
                ...
                {/* <button className="btn btn-primary">Enrol Today</button> */}
              </div>
            </div>
          </nav>
        </div>
        <div className="row bg-white px-0 mt-5 pt-5" >
          <div
          ...
          >
            ...
            <div className="row  justify-content-center">
              <div className="col-md-3 m-2 m-md-0">
                ...
                <button className="btn "style={{backgroundImage:"linear-gradient(#55038b, #9b108d)"}} ><a href="https://portal.piaic.org/signup" style={{textDecoration:"none"}} className="text-white">Enroll Today</a></button>

              </div>
              <div className="col-md-3 m-2 m-md-0">
                <button className="btn text-white"style={{backgroundImage:"linear-gradient(#55038b, #9b108d)"}}>View Courses</button>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <img src="capture-2.jpg" className="img-fluid" alt="" />
          </div>
        </div>
        <div className="row p-1  p-md-5 text-white" style={{backgroundImage:"linear-gradient(#55038b, #9b108d)"}}>
        ...
        <div className="row bg-white  p-1 p-md-4  justify-content-center ">
        ...
        <div className="row bg-white">
          <div className="col-md-10 p-3 text-end">
            <button className="btn text-white"style={{backgroundImage:"linear-gradient(#55038b, #9b108d)"}}>View Corses</button>
          </div>
        </div>
        <div className="row justify-content-center  bg-white">
          ...
          <div className="col-md-3">
            ...
            <div className="row">
              <div className="col-md-12">
                <input 
                  className="bg-white rounded p-2 w-75 mx-2"
                  placeholder="Enter"
                  type="text"
                />
            ...
            <div className="row p-2">
              <div className="col-md-12 ">
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Home</a><br />
                <a href="https://portal.piaic.org/signup" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Enroll Today</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >How It Works</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Artificial Intelligence</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Cloud native And Mobile Web Computing</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Metaverse</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Internet of Things</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >About The President</a><br />
                <a href="#" className="" style={{ textDecoration:"none", color:"black", fontWeight:"600" }} >Women Inclusion in Texhnology (WIT)</a><br />
                <a href="#"></a>
              </div>
            </div>
          </div>
        ...
        <div className="row bg-white">
          <div className="col-md-12 d-flex flex-row">
            ...
            <h6 className="w-50 text-end pb-4"><img src="capture-15.svg" height="40" alt="" /><a href="#" style={{ textDecoration:"none", color:"black", fontWeight:"600" }}><span className="text-dark" style={{ textDecoration:"underline" }}>Muhammad Faizan</span> 2023</a></h6>
